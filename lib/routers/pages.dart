...
import 'package:pdm_projeto_pesquisa/screens/detalhes_da_meta.dart';
...
class AppPages {
  static final List<GetPage> pages = [
    ...
    GetPage(
      name: Routes.FORMULARIO_COLETA,
      page: () => const FormularioDeColeta(),
    ),
    GetPage(
      name: Routes.NOVO_FORMULARIO,
      page: () => const NovoFormularioPage(),
    ),
    GetPage(
      name: Routes.HISTORICO_FORMULARIOS,
      page: () => const HistoricoFormulariosPage(),
    ),
    ...
    GetPage(name: Routes.REALIZAR_CHECK_OUT, page: () => RealizarCheckOut()),
